          ...
          <div class="col-10 col-md-8 col-lg-6"> 
            ...
            <div class = 'card p-5' style="background-color: #b6acab">
                <div class="form-group">
                    <div class="form-control" name="description" id="form4Example3" rows="8" style="background: #585858; color: black; height:4cm;font-size:40px; text-align:center; font-weight:bold; font-family: 'Roboto';">Your Payment Was declined</div>
                </div>              
            </div>
