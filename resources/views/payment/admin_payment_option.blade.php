...
<body>
    <!-- navbar 1-->
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <a href="{{url('onlinePaymentHistry')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Online Payment </span></button></a><br>
            <a href="{{url('adminBankDeposite')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Bank Deposite </span></button></a><br>
            <a href="{{url('allPaymentHistry')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Payment Histry </span></button></a><br>
            <a href="{{url('remaining')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Payment remaining </span></button></a><br>
            <a href="{{url('setupFees')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Student Payment Setting </span></button></a>
