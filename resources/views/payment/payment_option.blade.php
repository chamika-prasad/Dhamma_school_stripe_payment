...
<body>
    ...
    <!-- navbar 1-->
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <a href="{{url('stripe')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Online Payment </span></button></a><br>
            <a href="{{url('showBankDeposite')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Bank Deposite </span></button></a><br>
            <a href="{{url('paymentHistory')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Payment Histry </span></button></a>
        ...
        <div class="container bg-light" style="padding: 1.5cm; margin-top:1.5cm; margin-bottom:1.5cm;">
            <div class="col-md-12 text-center rounded " style="background-color: #959394;">
                <div style="padding-top: 25px; font-size:20px; font-weight:bolder;"> Payment Type : {{$payment->type}}</div><br>
                <div style=" font-size:20px; font-weight:bolder;">Last Payment Value : LKR {{$payment->amount}}</div><br>
                <div style="padding-bottom: 25px; font-size:20px; font-weight:bolder;">Your Last Payment Date : {{$lastpayment}}</div>
            </div>
        </div>
