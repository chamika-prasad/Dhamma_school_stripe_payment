...
<body>
    <!-- navbar 1-->
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <a href="{{url('approvedBankDepositeHistry')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Approved Bank deposite </span></button></a><br>
            <a href="{{url('pendingBankDeposite')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Pending Bank deposite </span></button></a><br>
            <a href="{{url('declineBankDepositeHistry')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Decline Bank deposite </span></button></a><br>
            </div>
        </div>
