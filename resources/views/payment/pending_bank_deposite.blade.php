...
<div style="text-align:center">
    <div class="list-group" style="padding-top: 1cm; width:80%; padding-left: 8cm;">
  
      
          @foreach ($payments as $payment)
  
              <a href="{{url('showUserBankSlip',$payment->id)}}"><button type="button" class="list-group-item list-group-item-action">{{ $payment->userName }}</button></a><br>
  ...
  {{-- {{url('showUserBankSlip',$payment->user_id)}} --}}
