...
<body>
    <!-- navbar 1-->
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <a href="{{url('admissionFees')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Admission Fees </span></button></a><br>
            <a href="{{url('otherFees')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Other Payments </span></button></a><br>
            <a href="{{url('admisionFeeReport')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Admission Fee Report </span></button></a>
