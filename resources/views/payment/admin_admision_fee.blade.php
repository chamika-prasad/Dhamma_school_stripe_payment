...
<body>
    <!-- navbar 1-->
              ...
              <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('#')}}">
                      ...
                      font-size: 24px;
                      line-height: 28px;
                      color:white;">&ensp;Admission Fees</span> </a>
                  </li>
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <h3>Add or Edit Admission fees</h3>   
            
            <form action="{{url('addAdmissionFee')}}" method="POST" class="form-horizontal">
                @csrf
            ...
            <form action="{{url('addAdmissionFeeEdit')}}" method="POST" class="form-horizontal">
                @csrf
