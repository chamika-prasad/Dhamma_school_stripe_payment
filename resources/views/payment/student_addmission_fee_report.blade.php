...
<body>
    <!-- navbar 1-->
              ...
              <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('#')}}">
                      ...
                      font-size: 24px;
                      line-height: 28px;
                      color:white;">&ensp;Admissin Fee Report</span> </a>
                  </li>
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <h3>Admissin Fee Report</h3><br>   
            
                  <!-- search bar-->

    <form action="{{url('searchAdmissionPayment')}}" method="POST">
      @csrf
    <div class="input-group">
      ...
      </button><a href="{{url('admisionFeeReport')}}" style="padding-top:18px; padding-left:8px; text-decoration:none; color:black; ">Show all Payment</a>
    </div>
  </form><br>
        ...
        <table class="table table-dark" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{date('H:i:s',strtotime($fee->created_at))}}</td>
              </tr>
