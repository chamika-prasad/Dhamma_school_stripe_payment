        ...
        <!-- navbar 1-->
             ...
             <nav class="navbar navbar-expand-sm " style="background-color: #7C5D5D;">
              ...
              <ul class="navbar-nav">
                  ...
                  <li><div>&emsp;&emsp;&emsp;&emsp;</div>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('pendingBankDeposite')}}">
                ...
                font-size: 24px;
                line-height: 28px;
                color:white;">&ensp;Pending Bank Slips</span> </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-window-stack" viewBox="0 0 16 16" style=" vertical-align: middle; color: black;">
                ...
                font-size: 24px;
                line-height: 28px;
                color:white;">&ensp;Bank Slips</span> </a>
            </li>
      ...
      <div class="row h-100 justify-content-center align-items-center">
          <div class="col-10 col-md-8 col-lg-6">
              ...
              <div class = 'card p-5' style="background-color: #b6acab; border-radius: 20px;" >
                ...
                <div><p  style="color: black; font-weight: bold;">Index No : {{ $Slip->userName }}</p></div>
                
                <!-- description -->
                <div >
                    <div class="text-center">
                        <img src="{{ asset('storage/images/'.$Slip->slipName) }}" class="rounded" alt="..."n style="width: 100%;">
                      </div>
                ...
                <div class="col-md-12 text-center" >
                  <a href="{{url('adminBankSlipAction',[1,$Slip->id])}}"><button type="submit" class="btn btn-success btn-lg" style="float: left;" ><span  style="font-size:20px; vertical-align: middle;  color: black; font-weight: bold;">&emsp;&ensp;Accept&ensp;&emsp;</span></button></a>
                  <a href="{{url('adminBankSlipAction',[2,$Slip->id])}}"><button type="submit" class="btn btn-danger btn-lg" style="float: right;" ><span  style="font-size:20px; vertical-align: middle;  color: black; font-weight: bold;">&emsp;&ensp;Decline&ensp;&emsp;</span></button></a>
                </div>
                <!-- buttons -->  
            </div>
              <!-- Form end -->
