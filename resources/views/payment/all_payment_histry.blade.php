        ...
        <!-- navbar 1-->
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">
                ...
                font-size: 24px;
                line-height: 28px;
                color:white;">&ensp;All Success Payments</span> </a>
            </li>
...
<!-- application -->
   ...
   <div class="form-outline mb-4" style="margin-top:1.5cm; padding-left:2cm; padding-right:2cm;">
    ...
    <form action="{{url('searchPayment')}}" method="POST">
      @csrf
    <div class="input-group">
      ...
      </button><a href="{{url('allPaymentHistry')}}" style="padding-top:18px; padding-left:8px; text-decoration:none; color:black; ">Show all Payment</a>
    </div>
  </form><br>
