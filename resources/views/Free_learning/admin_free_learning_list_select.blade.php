...
<head>
    ...
    <title>User Free Learning Lists</title>
</head>
<body>
        <!-- navbar 1-->
        ...
        <div class="container bg-light" style="padding: 1cm; margin-top:1.5cm;">
            ...
            <a href="{{url('adminFreeLearningSubmitList')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Pending List </span></button></a><br>
            <a href="{{url('adminFreeLearningApproveList')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Accepted List </span></button></a><br>
            <a href="{{url('adminFreeLearningDeclineList')}}"><button type="button" class="btn btn-success btn-lg btn-block" style="height : 2cm;"><span style="color : black; font-weight: bold;"> Decline List </span></button></a>
