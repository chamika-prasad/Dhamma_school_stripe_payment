...
<div style="text-align:center">
  <div class="list-group" style="padding-top: 1cm; width:80%; padding-left: 8cm;">
        ...
        @foreach ($users_list as $user_list)
            ...
            <a href="{{url('admin_show_application',[$list_type,$user_list->user_id])}}"><button type="button" class="list-group-item list-group-item-action">{{ $user_list->name }}</button></a><br>
