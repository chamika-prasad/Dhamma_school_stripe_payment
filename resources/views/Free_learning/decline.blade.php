        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">
                ...
                font-size: 24px;
                line-height: 28px;
                color:white;">&ensp;Free Learning Application</span> </a>
            </li>
          ...
          <div class="col-10 col-md-8 col-lg-6"> 
            ...
            <div class = 'card p-5' style="background-color: #b6acab">
                <div class="form-group">
                    <div class="form-control" name="description" id="form4Example3" rows="8" style="background: #585858; color: black; height:4cm;font-size:40px; text-align:center; font-weight:bold; font-family: 'Roboto';">Your Application Was Decline</div>
                </div>

                 <!-- button -->
            <div class="col-md-12 text-center" >
                <a href="{{url('applyagain')}}"><button type="submit" class="btn btn-success btn-lg" style="width:100%;" ><span  style="font-size:20px; vertical-align: middle;  color: black; font-weight: bold;" >&emsp;&ensp;Apply Again&ensp;&emsp;</span></button></a>
            </div>
              <!-- button --> 
