      ...
      <div>
        ...
        <div class="container-fluid" style="width: 85%; padding-bottom: 20px; padding-top: 20px;">
            <div class="card-deck ">
                ...
                <div class="card border-secondary mb-3 bg-secondary text-white" style="text-align: center">
                    <a href="{{url('adminPaymentOption')}}">
                        <button class="btn btn-secondary" >
                            <div class="card-body">
                                <h5 class="card-title">Payment</h5>
                                <p class="card-text">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Show All Payments&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</p>
                            </div>
                        </button>
                    </a>
                </div>
                ...
                <div class="card border-secondary mb-3 bg-secondary text-white" style="text-align: center">
                    <a href="{{url('admin_select_free_learning_list')}}">
                        <button class="btn btn-secondary" >
                            <div class="card-body">
                                <h5 class="card-title">Free learning List</h5>
                                <p class="card-text">&emsp;&emsp;&emsp;&emsp;&emsp; Show free learning applicant &emsp;&emsp;&emsp;</p>
                            </div>
                        </button>
                    </a>
                </div>
